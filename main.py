import lists,scraper,transformer,parsing,objects,cuisines
...
def main():
	...
	if transformationType ==0:
		...
		if cuisineType ==0:
			cuisines.cuisineChange(recipe,cuisineTypes[0])
		elif cuisineType ==1:
			cuisines.cuisineChange(recipe,cuisineTypes[1])
		elif cuisineType == 2:
			cuisines.cuisineChange(recipe,cuisineTypes[2])
		else:
